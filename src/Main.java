...
public class Main {
    ...
    //hybrid
    public static void merge_obj(Comparable[] arr, int beg, int mid, int end){
        int i, j, k;
        int n1 = mid-beg+1;
        int n2 = end-mid;
    ...
    public static void hybrid(Comparable[] arr, int beg, int end){
        if (end - beg > 40) {
            int m = beg + (end - beg) / 2;
...
//        merge(arg, arg2);
        ...
        Comparable[] myArr = new Comparable[5];
        myArr[0]="agh";
        myArr[1]="aaparatus";
        myArr[2]="xavery";
        myArr[3]="bobo";
        ...
        System.out.println("\ncomparing: " + myArr[1].compareTo(myArr[4]));
        System.out.println(Arrays.toString(myArr));
        hybrid(myArr, 0, myArr.length-1);
        System.out.println(Arrays.toString(myArr));
    }
}
